...
package com.rnworkshop.utility.camera.watermark.record.video;
...
import com.rnworkshop.utility.camera.watermark.gpufilter.basefilter.MagicCameraInputFilter;
import com.rnworkshop.utility.camera.watermark.record.gles.EglCore;
...
//    private MagicFilterType type = MagicFilterType.NONE;
    private AFilter mShowFilter=new NoFilter(MainApplication.getContext().getResources());
