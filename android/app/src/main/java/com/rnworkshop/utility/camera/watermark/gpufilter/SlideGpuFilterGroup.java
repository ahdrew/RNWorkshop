package com.rnworkshop.utility.camera.watermark.gpufilter;
...
import com.rnworkshop.utility.camera.Constants;
...
import com.rnworkshop.utility.camera.watermark.gpufilter.helper.MagicFilterFactory;
import com.rnworkshop.utility.camera.watermark.gpufilter.helper.MagicFilterType;
...
public class SlideGpuFilterGroup {
    ...
    public SlideGpuFilterGroup() {
        initFilter();
        scroller = new Scroller(MainApplication.getContext());
    }
