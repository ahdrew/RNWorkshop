...
//    [filter addTarget:cropFliter];
    ...
    UIImageView *waterFliter = [[UIImageView alloc] initWithFrame:CGRectMake(0, 64, 100, 100)];
...
- (void)stopVideoCamera:(NSURL *)movieURL {
    ...
    NSString *videoPath = [[WNAudioComposition alloc] exprotVideoWithAudio:[movieURL absoluteString] secondAsset:[movieURL absoluteString] saveFileName:@"myVideo"];
